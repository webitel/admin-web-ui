...
/**
 * Цей плагін оприділяє одну важливу фігуру ...Model
 * Ліба сама піклується про створення вюхи і magnets для взаємодії з UI. Тому ми легко можем клікнути і перетягувати 
 *     мишку з порта, а лінк сам створиться з початком від порта
 * Magnets це SVG піделементи, які служать липкими точкаи для лінків. Цей плагін сам оприділяє magnets 
 *
 * 
 * ???
 *     - як створити свій magnet
 *
 *
 *
 * 
